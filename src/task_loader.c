...
const u8 pal_847190C[32] = {
  0x2E, 0x53, 0xFF, 0x7F, 0x8C, 0x31, 0x5A, 0x67, 0x3C, 0x04, 0xFF, 0x3A, 0x64, 0x06, 0xD2, 0x4B, 0x46, 0x65, 0x14, 0x7B, 0x29, 0x35, 0x5B, 0x6F, 0xF5, 0x56, 0x31, 0x66, 0xAE, 0x41, 0xC5, 0x18, 0x00
};

const u8 pal_847192C[32] = {
  0x2E, 0x53, 0xFF, 0x7F, 0x8C, 0x31, 0x5A, 0x67, 0x3C, 0x04, 0xFF, 0x3A, 0x64, 0x06, 0xD2, 0x4B, 0x46, 0x65, 0x14, 0x7B, 0x1F, 0x7C, 0x1F, 0x7C, 0x1F, 0x7C, 0x1F, 0x7C, 0x1F, 0x7C, 0xC5, 0x18, 0x00
};
void task_loader(u8 task_id)
{
	...
	switch(*(*malloc_pointer_loc+2))
	{
		...
		case 4:
			...
			gpu_pal_apply(pal_847190C,0xE0,0x20);
			gpu_pal_apply(pal_847192C,0xF0,0x20);
			lcd_io_set(0x40,240);
